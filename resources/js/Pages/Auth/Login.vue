      ...
      <div class="md:max-w-md w-full px-4 py-4">
        <form @submit.prevent="submit">
          <div class="mb-12">
            ...
            <p class="text-sm mt-4 text-gray-800 dark:text-gray-200">Don't have an account <a href="javascript:void(0);" class="text-blue-600 dark:text-blue-400 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</a></p>
          </div>
