              ...
              <div v-if="showAddBreedingForm" class="modal">
                <div class="modal-content">
                  ...
                  <form @submit.prevent="addBreedingRecord">
                    <div class="mb-4">
                      <label for="sowId" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Sow ID</label>
                      <input type="number" id="sowId" v-model="breedingForm.sow_id" class="mt-1 block w-full p-2.5 bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    </div>
                    <div class="mb-4">
                      <label for="boarId" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Boar ID</label>
                      <input type="number" id="boarId" v-model="breedingForm.boar_id" class="mt-1 block w-full p-2.5 bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    </div>
                    <div class="mb-4">
